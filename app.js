...
const API_URL = 'https://zgadfjbyfozgegnoulir.supabase.co';
const API_KEY_ANON = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InpnYWRmamJ5Zm96Z2Vnbm91bGlyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjQxMjIyMTksImV4cCI6MjA3OTY5ODIxOX0.QE0JLGt5CBq8gnec4etVkDGuSslz8xbEIBcIQpPI0tk';

const supabase = 
    supabaseClient.createClient(API_URL, API_KEY_ANON);
